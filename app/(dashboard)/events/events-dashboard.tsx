...
export function EventsDashboardClient({
  ...
  useEffect(() => {
    ...
    async function refreshData() {
      const [{ data: newEvents }, { data: newInvitations }, { data: newLogs }] =
        await Promise.all([
          supabase
            .from("events")
            .select("*")
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div className="lg:col-span-7 flex flex-col gap-6">
        <header className="flex items-center justify-between mb-2 min-h-12">
          <div
            className={cn(
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-10 pb-8 border-b-2 border-foreground/10">
              ...
              <div className="flex flex-col gap-1.5 min-w-45">
                ...
                >
                  ...
                  <option value="created" className="bg-background">
                    DATE_CREATED
                  </option>
